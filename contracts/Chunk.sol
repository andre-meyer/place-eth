...
contract Chunk {
  ...
  event PixelUpdated(uint256 x, uint256 y, uint8 c);
  event PixelBoundaryUpdated(uint256 pixelRow, uint256 pixelData);
  ...
  function setPixelBoundary(uint256 boundIndex, uint256 pixelData) public {
    ...
    emit PixelBoundaryUpdated(boundIndex, pixelData);
  }
